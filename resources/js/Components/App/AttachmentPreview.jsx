...
const AttachmentPreview = ({file}) => {
    return (
        <div className="flex items-center justify-center w-full gap-2 px-3 py-2 rounded-md bg-slate-800">
            <div>
            ...
            <div className="flex-1 overflow-auto text-gray-400 text-nowrap text-ellipsis">
